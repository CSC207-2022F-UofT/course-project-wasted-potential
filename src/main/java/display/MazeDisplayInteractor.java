...
public class MazeDisplayInteractor implements MazeDisplayInputBoundary {
    ...
    public MazeDisplayResponseModel create(MazeDisplayRequestModel requestModel) {
        ...
        GameState maze = new GameState(publishedMaze.getAuthor(), publishedMaze.getName(), publishedMaze.getPublished(), publishedMaze.getPublishDate(), publishedMaze.getState(), publishedMaze.getStartPosition(), publishedMaze.getNumRow(), publishedMaze.getNumCol(), requestModel.getMazeID(), publishedMaze.getStartPosition().clone());
